...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    output = tf.layers.conv2d_transpose(layer7_1x1, num_classes, 4, 2, 'same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    output = tf.layers.conv2d_transpose(output, num_classes, 4, 2, 'same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
    ...
    output = tf.layers.conv2d_transpose(output, num_classes, 16, 8, 'same', kernel_regularizer=tf.contrib.layers.l2_regularizer(1e-3))
